package fr.yoannroche.java_s3_c4_interaction;
...
public class Bouton extends JButton implements MouseListener{
  ...
  public Bouton(String str){
    ...
    this.name = str;
    try {
      img = ImageIO.read(new File("src/fr/yoannroche/java_s3_c4_interaction/imgfond.png"));
    } catch (IOException e) {
      e.printStackTrace();
    }
  ...
  public void mouseEntered(MouseEvent event) {    
    ...
    try {
      img = ImageIO.read(new File("src/fr/yoannroche/java_s3_c4_interaction/img1.png"));   
    } catch (IOException e) {
      e.printStackTrace();
    }    
  }
  ...
  public void mousePressed(MouseEvent event) {
    ...
    try {
      img = ImageIO.read(new File("src/fr/yoannroche/java_s3_c4_interaction/img3.png"));
    } catch (IOException e) {
      e.printStackTrace();
    }    
  }
